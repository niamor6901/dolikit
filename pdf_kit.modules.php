...
/**
 *	\file       htdocs/core/modules/propale/doc/pdf_kit.modules.php
 *	\ingroup    propale
 *	\brief      File of Class to generate PDF proposal with kit template
 */
...
/**
 *	Class to generate PDF proposal kit
 */
class pdf_kit extends ModelePDFPropales
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "kit";
		$this->description = $langs->trans('Un modèle avec le détails des KIT');
